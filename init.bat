...
rem TRACE="--trace"
set TRACE=""
set HOME=%USERPROFILE%\.monchaind
echo %HOME%
...
monchaind start --pruning=nothing %TRACE% --log_level %LOGLEVEL% --minimum-gas-prices=0.0001aphoton